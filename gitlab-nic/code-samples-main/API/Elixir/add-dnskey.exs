...
# Example of use:
# mix run add-dnskey.exs café.fr 52726 RSASHA256 SHA256 91E907DB04319EAE1BAF14CE3006D94C4C94618BC4BF4CD7FA36DCF15B8AA8C9

url = "https://api-sandbox.nic.fr/v1/domains/"

if length(System.argv()) != 5 do
  raise "Boom Usage is add-dnskey domain tag algorithm digest-type digest"
end
...
args =
  Jason.encode!(%{
    ...
    extensions: %{
      dnsSec: %{
        keysToAdd: [%{keyTag: tag, algorithm: algorithm, digestType: digest_type, digest: digest}]
      }
    }
  })
