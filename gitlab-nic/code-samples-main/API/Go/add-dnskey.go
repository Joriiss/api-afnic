...
Example of use:
./add-dnskey café.fr 52726 RSASHA256 SHA256 91E907DB04319EAE1BAF14CE3006D94C4C94618BC4BF4CD7FA36DCF15B8AA8C9
...
func main() {
	...
	flag.Parse()
	if flag.NArg() != 5 {
		panic("Usage: add-dnskey domain tag algorithm digest-type digest")
	}
	domain := flag.Arg(0)
	...
	my_request.Extensions.Dnssec.KeysToAdd = make([]Keys, 1)
	my_request.Extensions.Dnssec.KeysToAdd[0].KeyTag = tag
	my_request.Extensions.Dnssec.KeysToAdd[0].Algorithm = flag.Arg(2)
	my_request.Extensions.Dnssec.KeysToAdd[0].DigestType = flag.Arg(3)
	my_request.Extensions.Dnssec.KeysToAdd[0].Digest = flag.Arg(4)
